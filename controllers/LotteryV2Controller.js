...
class LotteryV2Controller {
    ...
    static async loteryHistory(req, res) {
    ...
    static async pickWinner(req, res) {
        ...
        try {
            ...
            const pickWinnerResult = 
                await lotteryV2Interactor.pickWinner(wallet.result.account, CipherUtil.decrypt(wallet.result.private_key));
